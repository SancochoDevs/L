  ...
  return (
    <>
      ...
      <div className="page-width grid grid-cols-1 md:grid-cols-3 gap-2 justify-between">
        <div>
    <div className="card-icons flex justify-center space-x-1">
              <div>
                <svg
          ...
          <div className="links-container flex justify-center md:justify-around self-center">
      <ul className="footer-links">
        <li><a href="/page/legal">Aviso Legal</a></li>
        <li><a href="/page/Politica">Política Privacidad</a></li>
      </ul>
    </div>
          ...
          <div className="self-center">
            <div className="copyright text-center md:text-right text-textSubdued">
              <span>Copyright © 2023 <a href="https://huracanlacosta.com">Huracan La Costa</a></span>
            </div>
